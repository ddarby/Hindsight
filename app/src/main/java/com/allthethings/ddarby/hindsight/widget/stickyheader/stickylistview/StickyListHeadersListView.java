package com.allthethings.ddarby.hindsight.widget.stickyheader.stickylistview;
...
import com.allthethings.ddarby.hindsight.widget.stickyheader.StickHeaderViewInterceptTouchListener;
...
public class StickyListHeadersListView extends ListView {
    ...
    // SlidingUpPanelLayout fields
    private int mScrollTouchSlop;
    private float mInitialMotionX;
    private float mInitialMotionY;
    private StickHeaderViewInterceptTouchListener interceptTouchListener;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                if (getFirstVisiblePosition() == 0 && getChildAt(0).getTop() == 0 && y > mInitialMotionY) {
                    if (interceptTouchListener != null) {
                        interceptTouchListener.onInterceptListViewPanelTouchListener(ev);
                    }
                }
                break;
            }
    ...
    public void setInterceptTouchListener(StickHeaderViewInterceptTouchListener interceptTouchListener) {
